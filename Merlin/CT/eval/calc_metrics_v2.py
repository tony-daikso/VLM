...
RESULTS_CSV = "/root/Desktop/VLM/Merlin/CT/results/Merlin_infer_results_CG2_abdomen72_v2_reportstyle.csv"
OUT_CSV = "/root/Desktop/VLM/Merlin/CT/results/CG2_abdomen72_auc_per_finding_v2_reportstyle.csv"
...
for col in results.columns:
    ...
    for pid, score in zip(results["patient_id"], results[col]):
        if pid not in label_map or pd.isna(score):
            continue
