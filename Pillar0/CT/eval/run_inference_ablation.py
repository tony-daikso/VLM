...
import sys
VARIANT = sys.argv[1] if len(sys.argv) > 1 else "spacing_only"
# "spacing_only" = 1.5mm resample, no mean/std normalize
# "normalize_only" = 1.25mm resample, with mean/std normalize
...
if VARIANT == "spacing_only":
    ...
    PROCESSED_DIR = "/datadrive/VLM/Pillar0/CT/processed_abdomen"
    IMAGE_MEAN, IMAGE_STD = 0.289, 0.198
TEXT_EMB_PATH = "/datadrive/VLM/Pillar0/CT/text_embeddings.pt"
OUT_CSV = f"/root/Desktop/VLM/Pillar0/CT/results/Pillar0_infer_results_CG2_abdomen72_{VARIANT}.csv"
TARGET_SPATIAL = 384
