...
class CoCa(nn.Module):
    ...
    def _encode_image(self, images, normalize: bool = True, info = None):
        if info != None:
            image_latent, tokens_embs = self.visual(images, info)
        else:
    ...
    def forward(
        ...
        if image_latent is None or image_embs is None:
            if info != None:
                image_latent, image_embs = self._encode_image(image, info=info)
            else:
    ...
    def _generate_beamsearch(
        ...
        info = info * num_beams
        image_latent, image_embs = self._encode_image(image_inputs, info=info)
